...
int main(void)
{
	...
	//test 3
	ft_printf("test %d|", test++);
	n = ft_printf("%03.0x", -42); //
	ft_printf("|%d\n", n);
	
	//test 4
	ft_printf("test %d|", test++);
	n = ft_printf("%04.1x", -42); //
	ft_printf("|%d\n", n);
	
	//test 5
	ft_printf("test %d|", test++);
	n = ft_printf("%05.2x", -42); //
	ft_printf("|%d\n", n);
	
	//test 6
	ft_printf("test %d|", test++);
	n = ft_printf("%06.3x", -42); //
	ft_printf("|%d\n", n);
	
	//test 7
	ft_printf("test %d|", test++);
	n = ft_printf("%07.4x", -42); //
	ft_printf("|%d\n", n);
	
	//test 8
	ft_printf("test %d|", test++);
	n = ft_printf("%08.5x", -42); //
	ft_printf("|%d\n", n);
	
	//test 9
	ft_printf("test %d|", test++);
	n = ft_printf("%09.6x", -42); //
	ft_printf("|%d\n", n);
	...
	//test 11
	ft_printf("test %d|", test++);
	n = ft_printf("%011.0x", 0); //
	ft_printf("|%d\n", n);

	//test 12
	ft_printf("test %d|", test++);
	n = ft_printf("%012.x", 42); //
	ft_printf("|%d\n", n);

	//test 13
	ft_printf("test %d|", test++);
	n = ft_printf("%013.0x", 42); //
	ft_printf("|%d\n", n);
	
	//test 14
	ft_printf("test %d|", test++);
	n = ft_printf("%014.1x", 42); //
	ft_printf("|%d\n", n);
	
	//test 15
	ft_printf("test %d|", test++);
	n = ft_printf("%015.2x", 42); //
	ft_printf("|%d\n", n);
	
	//test 16
	ft_printf("test %d|", test++);
	n = ft_printf("%016.3x", 42); //
	ft_printf("|%d\n", n);
	
	//test 17
	ft_printf("test %d|", test++);
	n = ft_printf("%017.4x", 42); //
	ft_printf("|%d\n", n);
	
	//test 18
	ft_printf("test %d|", test++);
	n = ft_printf("%018.5x", 42); //
	ft_printf("|%d\n", n);
	
	//test 19
	ft_printf("test %d|", test++);
	n = ft_printf("%019.6x", 42); //
	ft_printf("|%d\n", n);
